...
import { filesRepo } from '.';
import testObjectsImport from '../../../../test/services/helpers/testObjects';
import appPromise from '../../../app';
import { getFileById, getFilesWithUserPermissionsByUserId, removeFilePermissionsByUserId } from './files.repo';
...
describe('files.repo.integration.test', () => {
	...
	before(async () => {
		...
		({ files: fileTestUtils, generateObjectId } = testObjectsImport(app));
