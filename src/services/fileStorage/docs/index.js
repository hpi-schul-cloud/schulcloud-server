module.exports = {
	...
	signedUrlService: {
		description: 'A service for generating signed urls, e.g. for uploading (action = putObject)'
		+ 'and downloading files (action = getObject)',
		create: {
			parameters: [
				{
				...
				{
					description: 'What the signed URL should be for, e.g. downloading (getObject) or'
					+ ' uploading (putObject)',
					required: true,
					name: 'action',
					type: 'string',
			...
			summary: 'Creates a new signed url for the given file information and path, e.g.'
