...
/**
 * Just because the route /wopi/files/:id should trigger different actions for a different 'X-WOPI-Override' header
 * value, this helper uses the correct function for a specific header
 */
