...
const modelName = 'passwordRecovery';
enableAuditLog(passwordRecoverySchema, { modelName });
const passwordRecoveryModel = mongoose.model(modelName, passwordRecoverySchema);
