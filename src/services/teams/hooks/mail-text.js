...
\nDu wurdest von ${inviter} eingeladen, dem Team '${teamName}' der ${SC_TITLE} beizutreten.
Da du noch keinen ${SC_TITLE} Account besitzt, folge bitte diesem Link,
...
\nDu wurdest von ${inviter} zu dem Team '${teamName}' der ${SC_TITLE} hinzugefügt.
