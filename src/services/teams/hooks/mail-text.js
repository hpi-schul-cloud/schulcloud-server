...
Da du noch keinen ${cloudTitle} Account besitzt, folge bitte diesem Link, um die Registrierung abzuschließen und dem `
+ `Team beizutreten: ${shortLink}${close}`;
...
module.exports = (hook, inviter) => {
	const {
		isResend, isUserCreated, email, linkData, user,
	} = hook.result || {};
