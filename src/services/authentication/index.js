...
module.exports = function init() {
	...
	const authHeaderExtractor = function authHeaderExtractor(req) {
	...
	authenticationService.docs = {
		...
		create: {
			...
			parameters: [{
				...
				{
					description: 'ID of the system that acts as a login provider.'
					+ ' Required for new accounts or accounts with non-unique usernames.',
					//in: 'path',
					required: false,
					name: 'systemId',
					type: 'string'
