...
/** saves the event-ids generated by the Schul-Cloud Calendar-Service
 * to given course in order to handle the events later on
 * todo: maybe refactor later if there are also class and school events
 * @param hook {Object} - contains the created event
 * * */
const persistCourseTimesEvent = hook => Promise.all(hook.result.map((event) => {
