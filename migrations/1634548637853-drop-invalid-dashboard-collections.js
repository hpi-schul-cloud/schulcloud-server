...
module.exports = {
	up: async function up() {
		...
		await mongoose.connection.db.dropCollection('dashboard-grid-element-model').catch(() => {});
		await mongoose.connection.db.dropCollection('dashboard-model-entity').catch(() => {});
		await mongoose.connection.db.dropCollection('default-grid-reference-model').catch(() => {});
