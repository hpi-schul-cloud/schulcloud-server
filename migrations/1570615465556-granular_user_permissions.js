	...
	up: async function up() {
		...
		await RoleModel.findOneAndUpdate(
			...
			},
			{
				$pull: {
					permissions: {
						$in: ['USER_VIEW', 'USER_EDIT', 'USERGROUP_VIEW'],
					},
				},
			},
		)
		...
		await RoleModel.findOneAndUpdate(
			...
			},
			{
				$addToSet: {
					permissions: {
						$each: ['STUDENT_EDIT', 'CLASS_VIEW', 'COURSE_VIEW'],
					},
				},
			},
		)
		...
		await RoleModel.findOneAndUpdate(
			...
			{
				$addToSet: {
					permissions: { $each: ['CLASS_VIEW', 'COURSE_VIEW'] },
				},
			},
		)
			.lean()
	...
	down: async function down() {
		...
		await RoleModel.findOneAndUpdate(
			...
			},
			{
				$pull: {
					permissions: {
						$in: ['STUDENT_EDIT', 'CLASS_VIEW', 'COURSE_VIEW'],
					},
				},
			},
		)
