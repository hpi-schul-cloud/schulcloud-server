...
import LDAPConnectionError from '../../../src/services/ldap/LDAPConnectionError';
import testObjectsImport from '../helpers/testObjects';
import knownBadConfig from './assets/knownBadConfig.json';
import knownGoodConfig from './assets/knownGoodConfig.json';
...
describe('LdapConfigService', () => {
	...
	before(async () => {
		...
		const appPromise = (await import('../../../src/app')).default;
