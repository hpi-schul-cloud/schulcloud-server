...
import { schoolModel as School, yearModel as YearModel } from '../../../src/services/school/model';
...
const { create: createSchool, info: createdSchoolIds } = schoolsImport(appPromise);
