...
describe('resolve/scopes service', function() {
	...
	it('get 404 if no user is found', function () {
		return service.get('00006e13b101c8742dc2d092').then(_ => {
			throw new Error('was not supposed to succeed');
		}).catch(err => {
	...
	it('return scopes if user is found', function () {
		return service.get('0000d213816abba584714c0a').then(data => {
