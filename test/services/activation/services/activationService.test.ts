...
const { createTestUser, createTestAccount, createTestActivation, cleanup } = testObjectsImport(
	appPromise
);

import util from '../../../../src/services/activation/utils/generalUtils';
import customUtils from '../../../../src/services/activation/utils/customStrategyUtils';
