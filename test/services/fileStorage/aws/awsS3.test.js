...
describe('AWS file storage strategy', () => {
	...
	describe.skip('getFiles', () => {
		it('gets all stored files for one user',
			() => aws.getFiles('0000d213816abba584714c0a', 'users/0000d213816abba584714c0a')
				.then((res) => {
					expect(res).to.not.be.undefined;
		...
		it('rejects with no permissions for user',
			() => aws.getFiles('0000d213816abba584714c0a', 'users/0000d213816abba584714123')
				.then(res => chai.fail('it succeeded', 'should have returned an error'),
					(err) => {
						expect(err).to.not.be.undefined;
		...
		it('rejects with no permissions for course',
			() => aws.getFiles('0000d213816abba584714c0a', 'courses/0000d213816abba584714123')
				.then(res => chai.fail('it succeeded', 'should have returned an error'),
					(err) => {
						expect(err).to.not.be.undefined;
						expect(err.message).to.contain("You don't have permissions");
		...
		it('rejects with no permissions for class',
			() => aws.getFiles('0000d213816abba584714c0a', 'classes/0000d213816abba584714123')
				.then(res => chai.fail('it succeeded', 'should have returned an error'),
					(err) => {
						expect(err).to.not.be.undefined;
						expect(err.message).to.contain("You don't have permissions");
	...
	describe('delete file', () => {
		it('deletes a file correctly',
			() => aws.deleteFile('0000d213816abba584714c0a', 'users/0000d213816abba584714c0a/example.jpg')
				.then((res) => {
					expect(res).to.not.be.undefined;
		...
		xit('deletes a folder correctly',
			() => aws.deleteDirectory('0000d213816abba584714c0a', 'users/0000d213816abba584714c0a/folderToBeDeleted/')
				.then((res) => {
					expect(res).to.not.be.undefined;
	...
	describe.skip('create directory', () => {
		it('creates a new directory',
			() => aws.createDirectory('0000d213816abba584714c0a', 'users/0000d213816abba584714c0a/test/')
				.then((res) => {
					expect(res).to.not.be.undefined;
