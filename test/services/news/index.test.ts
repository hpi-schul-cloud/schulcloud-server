...
const { cleanup, createTestUser, createTestRole, createTestSchool } = testObjectsImport(appPromise);
...
import { newsModel as News, newsHistoryModel as NewsHistory } from '../../../src/services/news/model';
