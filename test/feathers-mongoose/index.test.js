...
const adapter = require('../../src/utils/feathers-mongoose/service');
...
describe('Feathers Mongoose Service', () => {
	...
	before(async () => mongoose.createConnection('mongodb://localhost:27017/feathers'));

	describe('Requiring', () => {
		// eslint-disable-next-line global-require
		const lib = require('../../src/utils/feathers-mongoose');
