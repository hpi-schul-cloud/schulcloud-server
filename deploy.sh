...
function deploytoprods {
	...
	# brandenburg
	ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i .build/travis_rsa travis@open.hpi-schul-cloud.org schulcloud/schulcloud-server:latest brabu_server
	# open
	ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i .build/travis_rsa travis@open.hpi-schul-cloud.org schulcloud/schulcloud-server:latest open_server
	# thueringen
	...
	# demo
	ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i .build/travis_rsa travis@demo.hpi-schul-cloud.org schulcloud/schulcloud-server:latest demo_server
}
