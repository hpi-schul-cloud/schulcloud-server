...
export type CommonCartridgeManifestResourceProps = {
...
export class CommonCartridgeManifestResource extends CommonCartridgeResource {
	private readonly xmlBuilder = new Builder();

	public constructor(private readonly props: CommonCartridgeManifestResourceProps) {
		super(props);
	}
