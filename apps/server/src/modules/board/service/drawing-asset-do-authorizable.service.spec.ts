...
import { DrawingAssetDoAuthorizableService } from './drawing-asset-do-authorizable.service';

describe(DrawingAssetDoAuthorizableService.name, () => {
	let module: TestingModule;
	let boardDoRepo: DeepMocked<BoardDoRepo>;
	let service: DrawingAssetDoAuthorizableService;
	...
	beforeAll(async () => {
		...
		service = module.get(DrawingAssetDoAuthorizableService);
