...
export class FileStorageClientService {
	...
	async copyFilesOfParent(userId: EntityId, schoolId: EntityId, parentType: FileRecordParentType, parentId: EntityId) {
	...
	async listFilesOfParent(userId: EntityId, schoolId: EntityId, parentType: FileRecordParentType, parentId: EntityId) {
		const fileRequestInfo = FileRequestInfoBuilder.build(userId, schoolId, parentType, parentId);
