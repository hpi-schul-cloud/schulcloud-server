...
export class ConfigResponse {
	...
	@ApiProperty()
	public FEATURE_COLUMN_BOARD_OFFICE_DOCUMENT_EDIT_ENABLED: boolean;
	...
	constructor(config: ServerConfig) {
		...
		this.FEATURE_COLUMN_BOARD_OFFICE_DOCUMENT_EDIT_ENABLED = config.FEATURE_COLUMN_BOARD_OFFICE_DOCUMENT_EDIT_ENABLED;
