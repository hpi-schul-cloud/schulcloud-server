...
export class ConfigResponse {
	...
	@ApiProperty()
	public FEATURE_COLUMN_BOARD_AUDIO_RECORDING_ENABLED: boolean;
	...
	constructor(config: ServerConfig) {
		...
		this.FEATURE_COLUMN_BOARD_AUDIO_RECORDING_ENABLED = config.FEATURE_COLUMN_BOARD_AUDIO_RECORDING_ENABLED;
