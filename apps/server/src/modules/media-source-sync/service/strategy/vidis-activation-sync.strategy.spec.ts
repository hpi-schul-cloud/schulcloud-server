...
import { type OfferDTO, type SchoolActivationDTO, VidisClientAdapter } from '@infra/vidis-client';
import { vidisOfferItemFactory } from '@infra/vidis-client/testing';
import { type MediaSource, MediaSourceDataFormat, mediaSourceFactory } from '@modules/media-source';
import { type School, SchoolService } from '@modules/school';
import { type MediaSchoolLicense, MediaSchoolLicenseService, SchoolLicenseType } from '@modules/school-license';
