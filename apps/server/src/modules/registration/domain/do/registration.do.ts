...
export type RegistrationCreateProps = Pick<RegistrationProps, 'email' | 'firstName' | 'lastName' | 'consent'| 'language' | 'roomIds'>;
export type RegistrationUpdateProps = Omit<RegistrationCreateProps, 'email' | 'firstName' | 'lastName'>;
