...
const renderer = (model: IEditorModel): string => `<html style="margin: auto;">
<head>
    <meta charset="UTF-8">
    <script>
    ...
    <script>
        // H5PEditor expects window.parent to equal window.self
...
<body>
    ...
    <div data-iframe-height="" style="height: 0"></div>
    ...
    <script>
        ...
        (function($) {
            ...
            H5PEditor.getAjaxUrl = function(action, parameters) {
                const url = new URL(H5PIntegration.editor.ajaxPath + action, window.location.origin);
