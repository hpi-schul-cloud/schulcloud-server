...
import { Lti11LaunchQuery } from 'apps/server/src/modules/tool/controller/dto/request/lti11-launch.query';
import { Lti11LaunchResponse } from 'apps/server/src/modules/tool/controller/dto/response/lti11-launch.response';
