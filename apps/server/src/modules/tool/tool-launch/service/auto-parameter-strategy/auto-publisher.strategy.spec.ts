...
describe(AutoPublisherStrategy.name, () => {
	let module: TestingModule;
	let strategy: AutoPublisherStrategy;
	...
	beforeAll(async () => {
		...
		strategy = module.get(AutoPublisherStrategy);
	...
	describe('getValue', () => {
		describe('when the external tool has a medium id', () => {
			...
			it('should return the medium id', async () => {
				...
				expect(result).toEqual(externalTool.medium?.publisher);
			});
		});
