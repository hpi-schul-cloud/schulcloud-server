...
import { OauthProviderService, type ProviderOauthClient } from '@modules/oauth-provider/domain';
...
import { ExternalTool, type Lti11ToolConfig, Oauth2ToolConfig } from '../domain';
