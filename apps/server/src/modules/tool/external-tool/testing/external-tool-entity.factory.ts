...
export class ExternalToolEntityFactory extends BaseFactory<ExternalToolEntity, ExternalToolProps> {
	withName(name: string): this {
		const params: DeepPartial<ExternalToolProps> = {
			name,
		};
