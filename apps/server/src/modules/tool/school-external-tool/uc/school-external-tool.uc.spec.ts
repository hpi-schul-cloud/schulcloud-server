...
import { EntityId, Permission, SchoolExternalToolDO, User } from '@shared/domain';
import { schoolExternalToolDOFactory, setupEntities, userFactory } from '@shared/testing';
...
import { SchoolExternalToolQueryInput } from '../../uc/dto';
