...
import { ExternalToolRepoMapper } from '../../../external-tool/repo/mikro-orm/mapper/external-tool.repo.mapper';
...
import { type SchoolExternalToolQuery } from '../../uc/dto/school-external-tool.types';
