...
export class LdapStrategy extends PassportStrategy(Strategy, 'ldap') {
	...
	async validate(request: { body: LdapAuthorizationBodyParams }): Promise<ICurrentUser> {
		// TODO: can this be better structured? these are a bit too many empty lines // done
	...
	private async loadAccount(username: string, systemId: string, school: SchoolDO): Promise<AccountDto> {
		...
		// TODO: having to check for two values in order to find an account is not optimal and should be changed. EW-892
