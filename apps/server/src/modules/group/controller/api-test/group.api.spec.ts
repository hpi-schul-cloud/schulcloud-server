...
import { type ClassInfoSearchListResponse } from '../dto';
import { ClassSortQueryType } from '../dto/interface';
import { AUTHORIZATION_CONFIG_TOKEN, type AuthorizationConfig } from '@modules/authorization/authorization.config';
import { type SchoolPermissions } from '@modules/school/domain';
