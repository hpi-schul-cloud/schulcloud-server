	...
	describe('deleteUser', () => {
		describe('when user is missing', () => {
			const setup = () => {
				...
				const expectedResult = DomainOperationBuilder.build(DomainModel.USER, OperationModel.DELETE, 0, []);
		...
		describe('when user exists', () => {
			const setup = () => {
				...
				const expectedResult = DomainOperationBuilder.build(DomainModel.USER, OperationModel.DELETE, 1, [user1.id]);
