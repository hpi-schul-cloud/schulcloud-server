				...
				const expectedArray = [
					{
						...
						modifiedCounter: deletionLogEntity1.modifiedCounter,
						deletedCounter: deletionLogEntity1.deletedCounter,
					...
					},
					{
						...
						modifiedCounter: deletionLogEntity2.modifiedCounter,
						deletedCounter: deletionLogEntity2.deletedCounter,
