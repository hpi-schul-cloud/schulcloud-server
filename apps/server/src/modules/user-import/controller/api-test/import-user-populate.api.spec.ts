...
import { type SchulconnexResponse } from '@infra/schulconnex-client';
import { schulconnexResponseFactory } from '@infra/schulconnex-client/testing';
import { EntityManager, ObjectId } from '@mikro-orm/mongodb';
import { accountFactory } from '@modules/account/testing';
import { RoleName } from '@modules/role';
import { roleFactory } from '@modules/role/testing';
import { type SchoolFeature } from '@modules/school/domain';
import { schoolEntityFactory } from '@modules/school/testing';
import { ServerTestModule } from '@modules/server/server.app.module';
import { systemEntityFactory } from '@modules/system/testing';
import { USER_IMPORT_CONFIG_TOKEN, type UserImportConfig } from '@modules/user-import/user-import-config';
