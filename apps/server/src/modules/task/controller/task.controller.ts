...
export class TaskController {
	...
	async findAll(
		...
		const [tasksWithStatus, total] = await this.taskUc.findAll(currentUser.userId, paginationParams);
	...
	async findAllFinished(
		...
		const [tasksWithStatus, total] = await this.taskUc.findAllFinished(currentUser.userId, paginationParams);
