...
import { CourseExternalTool } from './external-tools/course-external-tool/course-external-tool.entity';
import { CourseGroup } from './coursegroup.entity';
import { DashboardGridElementModel, DashboardModelEntity } from './dashboard.model.entity';
import { ExternalTool } from './external-tools/external-tool/external-tool.entity';
...
import { SchoolExternalTool } from './external-tools/school-external-tool/school-external-tool.entity';
