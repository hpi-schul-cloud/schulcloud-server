...
export class DataBaseManager {
	...
	public async find<T extends BaseEntity>(
		...
		const entities = await this.em.find(constructor, query, options);
	...
	public async findAndCount<T extends BaseEntity>(
		...
		const [fileRecordEntities, count] = await this.em.findAndCount(constructor, query, options);
	...
	public async findOne<T extends BaseEntity>(
		...
		const entity = await this.em.findOneOrFail(constructor, query, options);
