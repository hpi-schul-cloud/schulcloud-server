...
import { FILE_STORAGE_CLIENT_CONFIG_TOKEN, type FileStorageClientConfig } from '../common-cartridge-clients.configs';
	...
	describe('getFileRecord', () => {
		describe('when fetching file records', () => {
			...
			it('should delegate to fileApi', async () => {
				...
				expect(fileApiMock.getFileRecord).toHaveBeenCalledWith(fileRecordId, AdapterUtils.createAxiosConfigForJwt(jwt));
