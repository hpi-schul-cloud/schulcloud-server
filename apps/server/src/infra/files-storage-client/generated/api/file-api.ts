...
export const FileApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		deleteFile: async (fileRecordId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/file/delete/{fileRecordId}`.replace(
				`{${'fileRecordId'}}`,
...
export const FileApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async deleteByParent(
			...
			parentType: FileRecordParentType,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileRecordListResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.deleteByParent(
				storageLocationId,
				storageLocation,
				parentId,
				parentType,
			...
			const localVarOperationServerBasePath =
				operationServerMap['FileApi.deleteByParent']?.[localVarOperationServerIndex]?.url;
		...
		async deleteFile(
			fileRecordId: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileRecordResponse>> {
		...
		async download(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap['FileApi.download']?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async uploadFromUrl(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.uploadFromUrl(
				storageLocationId,
				storageLocation,
				parentId,
				parentType,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap['FileApi.uploadFromUrl']?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const FileApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		...
		deleteByParent(
			...
			return localVarFp
				.deleteByParent(storageLocationId, storageLocation, parentId, parentType, options)
		...
		upload(
			...
			return localVarFp
				.upload(storageLocationId, storageLocation, parentId, parentType, file, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		uploadFromUrl(
			...
			return localVarFp
				.uploadFromUrl(storageLocationId, storageLocation, parentId, parentType, fileUrlParams, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class FileApi extends BaseAPI implements FileApiInterface {
	...
	public deleteFile(fileRecordId: string, options?: RawAxiosRequestConfig) {
		return FileApiFp(this.configuration)
			.deleteFile(fileRecordId, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public download(fileRecordId: string, fileName: string, range?: string, options?: RawAxiosRequestConfig) {
		return FileApiFp(this.configuration)
			.download(fileRecordId, fileName, range, options)
			.then((request) => request(this.axios, this.basePath));
	}
