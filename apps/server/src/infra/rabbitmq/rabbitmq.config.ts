...
export const SchulconnexGroupProvisioningExchange = Configuration.get(
	'PROVISIONING_SCHULCONNEX_GROUP_EXCHANGE'
) as string;
export const SchulconnexLicenseProvisioningExchange = Configuration.get(
	'PROVISIONING_SCHULCONNEX_LICENSE_EXCHANGE'
) as string;
