...
Dev: ![Travis Status](https://travis-ci.com/schul-cloud/schulcloud-server.svg?branch=master)
Production: ![Travis Status](https://travis-ci.com/schul-cloud/schulcloud-server.svg?branch=production)
